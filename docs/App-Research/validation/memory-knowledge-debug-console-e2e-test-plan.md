...
本节覆盖 `add-conversation-memory-auto-formation` 的最终链路，执行细节和上线 gate 见 [`conversation-memory-formation-rollout.md`](../../App-Adr/develop/skills/runbooks/conversation-memory-formation-rollout.md)。
