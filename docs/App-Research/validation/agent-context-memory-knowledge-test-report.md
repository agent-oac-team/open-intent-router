...
测试方案：`docs/App-Research/validation/agent-context-memory-knowledge-test-plan.md`
...
- 已新增可选 smoke helper：`scripts/smoke_mem0_memory_loop.py`。真实 PostgreSQL、Milvus Lite、mem0 SDK 和阿里 embedding 凭证可用时，按 `docs/App-Desc/architecture/mem0-memory-integration.md` 运行并记录结果。
