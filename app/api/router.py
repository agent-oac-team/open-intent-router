...
async def route(
    ...
    payload = _bind_route_principal(payload, principal)
...
async def invoke(
    ...
    payload = payload.model_copy(
        update={"user": bind_principal_user_context(payload.user, principal)}
    )
...
def _bind_route_principal(payload: RouteRequest, principal: NativePrincipal) -> RouteRequest:
    return payload.model_copy(update={"user": bind_principal_user_context(payload.user, principal)})
